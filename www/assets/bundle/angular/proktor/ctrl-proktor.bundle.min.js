...
angular.module("RdmApp").controller("koordinatorCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer",function(t,o,e,a,i,r,n,s){t.dtInstance={},t.selectData={},t.selectData.tingkat_id="",t.dtOptions=a.newOptions().withOption("searching",!0).withButtons([{extend:"copy",text:'<i class="fa fa-files-o"></i> Copy',titleAttr:"Copy"},{extend:"pdfHtml5",text:'<i class="fa fa-print" aria-hidden="true"></i> Print',download:"open",exportOptions:{columns:[0,1,2,3]},titleAttr:"Print",customize:function(t){o.customepdf(t,"Absen Siswa","Rapor Digital Madrasah")}},{extend:"excelHtml5",text:'<i class="fa fa-file-text-o"></i> Excel',exportOptions:{columns:[0,2,3]},titleAttr:"Excel"}]).withOption("columnDefs",[{responsivePriority:1,targets:-1},{responsivePriority:2,targets:0},{responsivePriority:3,targets:-2},{responsivePriority:4,targets:-3}]).withOption("responsive",!0).withOption("stateSave",!0).withOption("paging",!0).withOption("processing",!0).withPaginationType("full_numbers"),t.getdataKoordinator=function(){$(".table-responsive").block({}),s.post("proktor/kokurikuler/data",{tingkat_id:t.selectData.tingkat_id},(function(t){$(".table-responsive").unblock({}),o.dataKoordinator=t.data}))},t.getdataKoordinator(),t.pilihkoordinator=function(e){console.log(e),t.datakelasedit=o.arrPush(e),t.datakelasedit.edit=!0,$(".edit-modal").modal("show"),$(".modal-dialog").draggable({handle:".modal-header"})},t.simpankoordinator=function(){$(".edit-modal").modal("hide"),$.blockUI({}),s.post("proktor/kokurikuler/simpankoordinator",t.datakelasedit,(function(o){$.unblockUI({}),o.success?(t.getdataKoordinator(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:o.message}).then((t=>{t.value&&($(".edit-modal").modal("show"),$(".modal-dialog").draggable({handle:".modal-header"}))}))}))},t.hapuskoordinator=function(o){Swal.fire({type:"warning",title:"Perhatian",reverseButtons:!0,confirmButtonText:"Ya, Hapus!",showCancelButton:!0,html:"Apakah Anda yakin akan menghapus koordinator proyek kelas ini?"}).then((e=>{e.value&&($.blockUI({}),s.post("proktor/kokurikuler/hapuspembina",{koordinator_id:o.koordinator_id},(function(o){$.unblockUI({}),o.success?(t.getdataKoordinator(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Dihapus",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:o.message})})))}))}}]);
